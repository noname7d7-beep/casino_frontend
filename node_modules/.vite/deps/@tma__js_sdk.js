...
var Ut = (e, t, s) => t in e ? Wt(e, t, { enumerable: true, configurable: true, writable: true, value: s }) : e[t] = s;
...
var D = class _D extends Error {
  constructor(t, s, n) {
    super(s, { cause: n }), this.type = t, Object.setPrototypeOf(this, _D.prototype);
  }
};
function f(e, t, s) {
  return new D(e, t, s);
}
var jt = "ERR_METHOD_UNSUPPORTED";
var zt = "ERR_METHOD_PARAMETER_UNSUPPORTED";
var Ft = "ERR_UNKNOWN_ENV";
var Jt = "ERR_INVOKE_CUSTOM_METHOD_RESPONSE";
var Qt = "ERR_TIMED_OUT";
var Yt = "ERR_UNEXPECTED_TYPE";
var ct = "ERR_PARSE";
var Zt = "ERR_NAVIGATION_LIST_EMPTY";
var Kt = "ERR_NAVIGATION_CURSOR_INVALID";
var Ke = "ERR_NAVIGATION_ITEM_INVALID";
var Xe = "ERR_SSR_INIT";
var Xt = "ERR_INVALID_PATH_BASE";
function E() {
...
var ue = class {
  ...
  set(t, s) {
    Object.entries(typeof t == "string" ? { [t]: s } : t).reduce((r, [i, o]) => this.state[i] === o || o === void 0 ? r : (this.state[i] = o, this.ee.emit(`change:${i}`, o), true), false) && this.ee.emit("change", this.state);
  }
  /**
...
var le = class extends Z {
  constructor(s, n, r) {
    ...
    c(this, "on", (s2, n2) => s2 === "click" ? b("back_button_pressed", n2) : this.state.on(s2, n2));
    c(this, "off", (s2, n2) => s2 === "click" ? L("back_button_pressed", n2) : this.state.off(s2, n2));
    this.postEvent = r;
  }
  set isVisible(s) {
...
var Et = x((e) => e instanceof Date ? e : new Date(y().parse(e) * 1e3), "Date");
function K(e, t) {
  return new M((s) => {
...
var hs = l(
  ({ version: e, postEvent: t }) => new Ne(false, e, t)
);
var De = class extends Y {
  constructor({ postEvent: s, ...n }) {
    super(n);
    c(this, "postEvent");
    c(this, "on", (s2, n2) => s2 === "click" ? b("main_button_pressed", n2) : this.state.on(s2, n2));
    c(this, "off", (s2, n2) => s2 === "click" ? L("main_button_pressed", n2) : this.state.off(s2, n2));
    this.postEvent = s;
  }
  /**
...
var Le = class extends k {
  constructor({ postEvent: s, createRequestId: n, version: r, botInline: i, ...o }) {
    ...
    this.supports = (h) => a(h) ? h !== "switchInlineQuery" || i : false, this.supportsParam = Dt(r, {
...
var ls = l(
  ({ postEvent: e, version: t }) => new Be(false, t, e)
);
...
var ds = l(
  ({ version: e, postEvent: t }) => new We(false, e, t)
);
var Ue = class extends Z {
  constructor(s, n, r) {
    ...
    c(this, "on", (s2, n2) => s2 === "click" ? b("settings_button_pressed", n2) : this.state.on(s2, n2));
    c(this, "off", (s2, n2) => s2 === "click" ? L("settings_button_pressed", n2) : this.state.off(s2, n2));
    this.postEvent = r;
  }
  set isVisible(s) {
...
function Es(e = true) {
  ...
  return R("iframe_ready", { reload_supported: true }), s;
}
function xs() {
...
var ze = class {
   ...
   */
  attach() {
    this.attached || (this.attached = true, this.sync(), b("back_button_pressed", this.back));
  }
  /**
   ...
   */
  detach() {
    this.attached = false, L("back_button_pressed", this.back);
  }
  /**
...
var $t = class {
  constructor(t, s, { postEvent: n, hashMode: r = "classic", base: i } = {}) {
    ...
    c(this, "base");
    c(this, "attached", false);
    c(this, "onPopState", ({ state: t2 }) => {
      if (t2 === null)
        return this.push(this.parsePath(window.location.href));
      t2 === it ? window.history.forward() : t2 === U && this.back(), t2 === H && this.forward();
    });
